...
def plot_decision_regions_3class( model, data_set, momentum=0.0):
    ...
    plt.title(("decision region | Momentum=" + str(momentum)))
    plt.legend()
    plt.show()
...
plot_decision_regions_3class( model, data_set, momentum= 0.1)
...
plot_decision_regions_3class( model, data_set, momentum= 0.2)
...
plot_decision_regions_3class( model, data_set, momentum=0.4)
...
plot_decision_regions_3class( model, data_set, momentum= 0.5)
...
train_loader = DataLoader(dataset=data_set, batch_size=20)
criterion = nn.CrossEntropyLoss()
Results["momentum 0.6"] = train(data_set, model, criterion, train_loader, optimizer, epochs=100)
plot_decision_regions_3class( model, data_set, momentum= 0.6)
